Public Class Form1
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Buttonsuma.Click
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Buttonresta.Click
        Dim Numero1 As Double = Double.Parse(TextBox1.Text)
        Dim Numero2 As Double = Double.Parse(TextBox2.Text)
        Dim resultado As Double = Numero1 - Numero2
        Label4.Text = resultado.ToString()
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Buttonpor.Click
        Dim Numero1 As Double = Double.Parse(TextBox1.Text)
        Dim Numero2 As Double = Double.Parse(TextBox2.Text)
        Dim resultado As Double = Numero1 * Numero2
        Label4.Text = resultado.ToString()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Buttonentre.Click
        Dim Numero1 As Double = Double.Parse(TextBox1.Text)
        Dim Numero2 As Double = Double.Parse(TextBox2.Text)
        Dim resultado As Double = Numero1 / Numero2
        Label4.Text = resultado.ToString()
